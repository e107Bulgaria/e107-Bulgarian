...
define("LANUPLOAD_REFUSED_TOKEN_MISSING", "Нищо не беше качено, защото заявката не съдържаше защитен токен. Качвайте файлове чрез Медийния мениджър, а не чрез отметка или връзка от друг сайт.");
