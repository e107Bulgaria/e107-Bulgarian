...
class theme_config implements e_theme_config
{
	function config($type='front')
	{
		...
		$previewLink = " <a class='btn btn-default btn-secondary e-modal' data-modal-caption=\"Използвайте меню „Теми“, за да разгледате наличните варианти.\" href='http://bootswatch.com/default/'>".LAN_PREVIEW."</a>";
