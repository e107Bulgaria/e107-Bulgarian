<?php
/*
 * Templates for gallery plugin - Bootstrap3 Bulgarian localized overlay.
 */

$GALLERY_TEMPLATE['list']['caption'] = "Моята галерия";
$GALLERY_TEMPLATE['list']['start'] = '{GALLERY_BREADCRUMB}<div class="row gallery">';
...
$GALLERY_TEMPLATE['cat']['start'] = '{GALLERY_BREADCRUMB}<div class="row gallery-cat">';
$GALLERY_TEMPLATE['cat']['item'] = '
	<div class="span3 col-xs-6 col-md-3">
		<div>{GALLERY_CAT_THUMB}<h3>{GALLERY_CAT_TITLE}</h3></div>
	</div>
';
...
<div id="gallery-slideshow-wrapper">
	<div id="gallery-slideshow-content">{GALLERY_SLIDES=4}</div>
</div>
<div class="gallery-slideshow-controls">
	<a href="#" class="gallery-control gal-next btn btn-sm btn-xs btn-default btn-secondary pull-right float-right">' . LAN_NEXT . ' {GLYPH=fa-chevron-right}</a>
	<a href="#" class="gallery-control gal-prev btn btn-sm btn-xs btn-default btn-secondary">{GLYPH=fa-chevron-left} ' . LAN_PREVIOUS . '</a>
...
';
$GALLERY_TEMPLATE['prettyphoto']['image_item'] = '<img id="fullResImage" src="{path}" />';
...
';
$GALLERY_TEMPLATE['prettyphoto']['iframe_item'] = '<iframe src="{path}" width="{width}" height="{height}" frameborder="no"></iframe>';
$GALLERY_TEMPLATE['prettyphoto']['inline_item'] = '<div class="pp_inline">{content}</div>';
...
<div class="pp_social">
	...
	<div class="facebook">
		<iframe src="http://www.facebook.com/plugins/like.php?locale=bg_BG&href=\'+location.href+\'&amp;layout=button_count&amp;show_faces=true&amp;width=500&amp;action=like&amp;font&amp;colorscheme=light&amp;height=23" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:500px; height:23px;" allowTransparency="true"></iframe>
	</div>
</div>
';
$GALLERY_TEMPLATE['merged-example'] = 'Пример';
