...
define("LAN_SOCIAL_ADMIN_46", "Това са наличните доставчици за социален вход, които все още не са настроени. След като настроите и запазите доставчик, той ще бъде преместен в секцията [b]Настроени[/b].");
